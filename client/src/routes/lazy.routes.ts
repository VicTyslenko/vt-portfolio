...
export namespace LazyRoutes {
  ...
  export const AboutPage = lazy(() => import("pages/about/AboutPage").then(({ AboutPage }) => ({ default: AboutPage })));
  export const ServicesPage = lazy(() => import("pages/services/ServicesPage/ServicesPage").then(({ ServicesPage }) => ({ default: ServicesPage })));
