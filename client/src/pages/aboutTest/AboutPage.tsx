    ...
    <div className="about-page-container">
      ...
      >
        ...
        <p className="description">
          As a passionate Frontend Developer, I specialize in creating dynamic web applications. Using technologies like HTML, CSS, SASS, JavaScript,
          ReactJS, and NodeJS, I strive to deliver seamless and responsive designs. My focus is on optimizing user experience through innovative
          solutions and clean, efficient code. I continuously seek to stay ahead of industry trends and am committed to personal growth and
